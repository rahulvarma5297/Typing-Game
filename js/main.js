...
function getStats() {
  ...
  let accProgress = setInterval(() => {
    ...
    allCircularProgress[0].style.background = `conic-gradient(#3f5cc3 ${
      accProgressStartValue * 3.6
    }deg, #ededed 0deg)`;
  ...
  let cpmProgress = setInterval(() => {
    ...
    document.querySelector(
      ".prog-cpm .progress-value"
    ).innerHTML = `${cpmProgressStartValue} <small>Letter/Min</small>`;
  ...
  let wpmProgress = setInterval(() => {
    wpmProgressStartValue++;
    document.querySelector(
      ".prog-wpm .progress-value"
    ).innerHTML = `${wpmProgressStartValue} <small>WPM</small>`;
...
function resultatExplication() {
  ...
  if (acc < 50) {
    a =
      "<strong>Your accuracy</strong> is Weak. You’ll automatically type faster when you make fewer mistakes. You’ll get there quickly with a little training!";
  } else if (acc > 50 && acc < 75) {
    a =
      "<strong>Your accuracy</strong> is okay. You’ll automatically type faster when you make fewer mistakes. You’ll get there quickly with a little training!";
  } else if (acc > 75 && acc < 95) {
    a =
      "<strong>Your accuracy</strong> is good. You’ll automatically type faster when you make fewer mistakes. You’ll get there quickly with a little training!";
  } else if (acc > 85 && sp < 25) {
    a =
      "<strong>Your accuracy</strong> is alright, but it seems to be affecting your typing speed a little bit. Remember, practice makes perfect!";
  } else {
    a =
      "<strong>Your accuracy</strong> is excellent. Practice makes perfection!";
  }
  document.querySelector(".acc p").innerHTML = a;
  // Speed
  if (sp < 20) {
    s =
      "<strong>Your Speed</strong> is below average. If you practice often, you could easily type twice as fast and greatly increase your productivity.";
  } else if (sp > 20 && sp < 40) {
    s =
      "<strong>Your Speed</strong> is slightly below average. With a little training, you could greatly improve your skills and increase your productivity.";
  } else {
